/* config.h.  Hand-maintained build configuration for gkc.
   Originally generated by autoconf; the autotools machinery has been
   removed, so edit this file directly.  Keep it in step with
   config-gcc.h and config-w32.h.  */
