...
#define yyparse         wg_yyprologparse
#define yylex           wg_yyprologlex
#define yyerror         wg_yyprologerror
#define yydebug         wg_yyprologdebug
#define yynerrs         wg_yyprolognerrs

/* First part of user prologue.  */
#line 30 "Parser/dbprolog.y"
...
static const yytype_uint8 yyrline[] =
{
      ...
      91,    94,    95,    98,    99,   100,   101,   102,   105,   108,
     109,   110,   130,   133,   136,   145,   148,   149,   150,   153,
     154,   155,   156
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 75 "Parser/dbprolog.y"
                        { yyval = MKWGPAIR(DBPARM,yyvsp[0],MKWGNIL); }
#line 1360 "Parser/dbprolog.tab.c"
    break;

  case 3:
#line 78 "Parser/dbprolog.y"
                                { yyval = MKWGNIL; }
#line 1366 "Parser/dbprolog.tab.c"
    break;

  case 4:
#line 79 "Parser/dbprolog.y"
                                { yyval = MKWGPAIR(DBPARM,yyvsp[-1], yyvsp[0]); }
#line 1372 "Parser/dbprolog.tab.c"
    break;

  case 5:
#line 82 "Parser/dbprolog.y"
             { yyval = yyvsp[0]; }
#line 1378 "Parser/dbprolog.tab.c"
    break;

  case 6:
#line 83 "Parser/dbprolog.y"
             { yyval = yyvsp[0]; }
#line 1384 "Parser/dbprolog.tab.c"
    break;

  case 7:
#line 86 "Parser/dbprolog.y"
                       { yyval = MKWGPAIR(DBPARM,yyvsp[-1], MKWGNIL); }
#line 1390 "Parser/dbprolog.tab.c"
    break;

  case 8:
#line 89 "Parser/dbprolog.y"
                                        { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-3]), yyvsp[-1]); }
#line 1396 "Parser/dbprolog.tab.c"
    break;

  case 9:
#line 90 "Parser/dbprolog.y"
                                          { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"not"), MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-3]), yyvsp[-1]), MKWGNIL)); }
#line 1402 "Parser/dbprolog.tab.c"
    break;

  case 10:
#line 91 "Parser/dbprolog.y"
                                          { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"~"), MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-3]), yyvsp[-1]), MKWGNIL)); }
#line 1408 "Parser/dbprolog.tab.c"
    break;

  case 11:
#line 94 "Parser/dbprolog.y"
                                        { yyval = MKWGPAIR(DBPARM,yyvsp[0], MKWGNIL); }
#line 1414 "Parser/dbprolog.tab.c"
    break;

  case 12:
#line 95 "Parser/dbprolog.y"
                                        { yyval = MKWGPAIR(DBPARM,yyvsp[-2], yyvsp[0]); }
#line 1420 "Parser/dbprolog.tab.c"
    break;

  case 13:
#line 98 "Parser/dbprolog.y"
                        { yyval = yyvsp[0]; }
#line 1426 "Parser/dbprolog.tab.c"
    break;

  case 14:
#line 99 "Parser/dbprolog.y"
                        { yyval = MKWGSTRING(DBPARM,yyvsp[0]); }
#line 1432 "Parser/dbprolog.tab.c"
    break;

  case 15:
#line 100 "Parser/dbprolog.y"
                        { yyval = MKWGINT(DBPARM,yyvsp[0]); }
#line 1438 "Parser/dbprolog.tab.c"
    break;

  case 16:
#line 101 "Parser/dbprolog.y"
                        { yyval = MKWGSTRING(DBPARM,yyvsp[0]); }
#line 1444 "Parser/dbprolog.tab.c"
    break;

  case 17:
#line 102 "Parser/dbprolog.y"
                        { yyval = MKWGSTRING(DBPARM,yyvsp[0]); }
#line 1450 "Parser/dbprolog.tab.c"
    break;

  case 18:
#line 105 "Parser/dbprolog.y"
                                { yyval = MKWGPAIR(DBPARM,yyvsp[-3], yyvsp[-1]); }
#line 1456 "Parser/dbprolog.tab.c"
    break;

  case 19:
#line 108 "Parser/dbprolog.y"
                                { yyval = MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"not"), MKWGPAIR(DBPARM,yyvsp[0], MKWGNIL)), MKWGNIL); }
#line 1462 "Parser/dbprolog.tab.c"
    break;

  case 20:
#line 109 "Parser/dbprolog.y"
                                { yyval = MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"not"), MKWGPAIR(DBPARM,yyvsp[-2], MKWGNIL)), yyvsp[0]); }
#line 1468 "Parser/dbprolog.tab.c"
    break;

  case 21:
#line 110 "Parser/dbprolog.y"
                                { yyval = MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"and"), MKWGPAIR(DBPARM,yyvsp[-2], yyvsp[0])), MKWGNIL); }
#line 1474 "Parser/dbprolog.tab.c"
    break;

  case 22:
#line 130 "Parser/dbprolog.y"
                   { yyval = yyvsp[-1]; }
#line 1480 "Parser/dbprolog.tab.c"
    break;

  case 23:
#line 133 "Parser/dbprolog.y"
                                  { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-3]), MKWGPAIR(DBPARM,yyvsp[-1], MKWGNIL)); }
#line 1486 "Parser/dbprolog.tab.c"
    break;

  case 24:
#line 136 "Parser/dbprolog.y"
                                        {yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-5]), MKWGPAIR(DBPARM,yyvsp[-3], MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,":-"), yyvsp[0]))); }
#line 1492 "Parser/dbprolog.tab.c"
    break;

  case 25:
#line 145 "Parser/dbprolog.y"
                { yyval = yyvsp[-1]; }
#line 1498 "Parser/dbprolog.tab.c"
    break;

  case 26:
#line 148 "Parser/dbprolog.y"
                { yyval = yyvsp[0]; }
#line 1504 "Parser/dbprolog.tab.c"
    break;

  case 27:
#line 149 "Parser/dbprolog.y"
                      { yyval = MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"and"), MKWGPAIR(DBPARM,yyvsp[-2], yyvsp[0])), MKWGNIL); }
#line 1510 "Parser/dbprolog.tab.c"
    break;

  case 28:
#line 150 "Parser/dbprolog.y"
                      { yyval = MKWGPAIR(DBPARM,MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"or"), MKWGPAIR(DBPARM,yyvsp[-2], yyvsp[0])), MKWGNIL); }
#line 1516 "Parser/dbprolog.tab.c"
    break;

  case 29:
#line 153 "Parser/dbprolog.y"
                         { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,yyvsp[-3]), MKWGPAIR(DBPARM,yyvsp[-1], MKWGNIL)); }
#line 1522 "Parser/dbprolog.tab.c"
    break;

  case 30:
#line 154 "Parser/dbprolog.y"
                        { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"not"), yyvsp[-1]); }
#line 1528 "Parser/dbprolog.tab.c"
    break;

  case 31:
#line 155 "Parser/dbprolog.y"
                { yyval = yyvsp[0]; }
#line 1534 "Parser/dbprolog.tab.c"
    break;

  case 32:
#line 156 "Parser/dbprolog.y"
                { yyval = MKWGPAIR(DBPARM,MKWGSTRING(DBPARM,"cut"), MKWGNIL); }
#line 1540 "Parser/dbprolog.tab.c"
    break;


#line 1544 "Parser/dbprolog.tab.c"
