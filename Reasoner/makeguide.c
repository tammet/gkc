...
if (probsize>9) { 
 ...
 pos+=sprintf(buf+pos, "  {\"max_dseconds\": %d, \"strategy\":[\"unit\"], \"query_preference\": 1, \"sine\":1, \"var_weight\": 1, \"weight_select_ratio\":100, \"repeat_var_weight\":1},\n",dsecs);
  ...
  if (probsize<10) {
    ...
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"query_preference\":0, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":2, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"max_depth\":0, \"length_penalty\":100, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"max_depth\":3, \"query_preference\":0, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"query_preference\":0, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":2, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"max_depth\":0, \"length_penalty\":100, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    if (1) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"positive_pref\"], \"query_preference\":0},\n",dsecs);
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"max_depth\":3, \"query_preference\":0, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
  ...
  if (probsize<10) {
    ...
    if (iteration<4 && qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\", \"double\"], \"query_preference\":1},\n",dsecs);
    ...
    if (iteration<4 && qp2ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":50, \"query_preference\":2, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":0, \"strategy\":[\"negative_pref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":0, \"strategy\":[\"hardness_pref\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\", \"positive_pref\"], \"query_preference\":1},\n",dsecs);
    if (iteration<4 && eq) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"rewrite\":0, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"hardness_pref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && queryok && qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"query_focus\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"unit\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && eq && queryok && qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"rewrite\":0, \"length_penalty\":100, \"query_preference\":1, \"strategy\":[\"query_focus\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":1, \"strategy\":[\"positive_pref\", \"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":0, \"strategy\":[\"positive_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"negative_pref\", \"hornpref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"negative_pref\"], \"query_preference\":1, \"var_weight\":1, \"repeat_var_weight\":1},\n",dsecs);
    ...
    if (iteration<4 && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":1, \"strategy\":[\"query_focus\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"hardness_pref\", \"hornpref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && eq && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"query_focus\", \"hornpref\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && eq && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":0, \"strategy\":[\"hardness_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"query_preference\":1, \"strategy\":[\"unit\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && eq && qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":2, \"strategy\":[\"hardness_pref\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"query_preference\":1, \"strategy\":[\"positive_pref\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && sineok) pos+=sprintf(buf+pos, "{\"sine\":2, \"weight_select_ratio\":5, \"query_preference\":0, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (1) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"hardness_pref\"], \"query_preference\":0, \"weight_select_ratio\":20, \"depth_penalty\":50, \"length_penalty\":100},\n",dsecs);
    if (qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"unit\", \"prohibit_nested_para\"], \"query_preference\":1, \"reverse_clauselist\":1},\n",dsecs);
    if (qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    if (sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":0, \"strategy\":[\"negative_pref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (queryok && qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"query_focus\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"query_preference\":2, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"query_preference\":0, \"strategy\":[\"positive_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (queryok && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":1, \"strategy\":[\"query_focus\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":0, \"strategy\":[\"hardness_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (queryok && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\", \"positive_pref\"], \"query_preference\":1},\n",dsecs);
    if (eq) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"rewrite\":0, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"hardness_pref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (1) pos+=sprintf(buf+pos, "{\"max_depth\":0, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"unit\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"unit\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (1) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"hardness_pref\", \"max_ground_weight\"], \"query_preference\":0},\n",dsecs);
    if (1) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":0, \"strategy\":[\"negative_pref\", \"hornpref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"hardness_pref\", \"hornpref\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    if (eq && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"query_focus\", \"hornpref\"], \"max_dseconds\":%d},\n",dsecs);
    if (eq && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":0, \"strategy\":[\"hardness_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"depth_penalty\":50, \"query_preference\":1, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"length_penalty\":100, \"query_preference\":1, \"strategy\":[\"positive_pref\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    if (sineok) pos+=sprintf(buf+pos, "{\"sine\":2, \"weight_select_ratio\":5, \"query_preference\":0, \"strategy\":[\"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (eq && queryok && qp1ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"rewrite\":0, \"length_penalty\":100, \"query_preference\":1, \"strategy\":[\"query_focus\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"var_weight\":70, \"repeat_var_weight\":70, \"length_penalty\":100, \"depth_penalty\":100, \"query_preference\":1, \"strategy\":[\"positive_pref\", \"unit\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (qp1ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"query_preference\":1, \"strategy\":[\"unit\", \"max_weight\"], \"max_dseconds\":%d},\n",dsecs);
    ...
    if (qp2ok) pos+=sprintf(buf+pos, "{\"weight_select_ratio\":5, \"depth_penalty\":50, \"query_preference\":2, \"strategy\":[\"negative_pref\"], \"max_dseconds\":%d},\n",dsecs);
    if (queryok && qp3ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\"], \"query_preference\":3},\n",dsecs);
    if (eq) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"unit\", \"pure_unit\"], \"max_size\":30, \"max_depth\":10, \"max_weight\":300, \"weight_select_ratio\":1, \"rewrite\":0},\n",dsecs);
    if (qp1ok && sineok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"negative_pref\"], \"query_preference\":1, \"sine\":2},\n",dsecs);
    if (sineok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"negative_pref\"], \"query_preference\":0, \"depth_penalty\":100, \"sine\":1},\n",dsecs);
    if (queryok && qp2ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\", \"unit\"], \"query_preference\":2},\n",dsecs);
    if (eq && qp2ok && sineok) pos+=sprintf(buf+pos, "{\"sine\":1, \"weight_select_ratio\":5, \"rewrite\":0, \"depth_penalty\":50, \"query_preference\":2, \"strategy\":[\"hardness_pref\", \"posunitpara\"], \"max_dseconds\":%d},\n",dsecs);
    if (iteration<4 && queryok && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"query_focus\"], \"query_preference\":1},\n",dsecs);
    if (iteration<4 && qp1ok) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"negative_pref\"], \"query_preference\":1},\n",dsecs);
    if (iteration<4) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"negative_pref\"], \"query_preference\":0},\n",dsecs);
    if (iteration<4) pos+=sprintf(buf+pos, "{\"max_dseconds\":%d, \"strategy\":[\"hardness_pref\"], \"query_preference\":0},\n",dsecs);
